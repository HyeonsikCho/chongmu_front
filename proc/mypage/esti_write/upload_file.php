...
// Settings
    ...
    //절대경로 /home/dprinting/front
	$save_path = $_SERVER["DOCUMENT_ROOT"].DIRECTORY_SEPARATOR.$upload_path.DIRECTORY_SEPARATOR.$util->getYmdDirPath();

    //DB에 기록될 다운로드 경로
    $down_path = DIRECTORY_SEPARATOR.$upload_path.DIRECTORY_SEPARATOR.$util->getYmdDirPath();
