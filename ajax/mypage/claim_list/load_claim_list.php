...
include_once($_SERVER["DOCUMENT_ROOT"] . "/com/nexmotion/job/mypage/ClaimListDAO.php");
...
$rs = $claimDAO->selectClaimList($conn, $param);

$param["type"] = "COUNT";
$count_rs = $claimDAO->selectClaimList($conn, $param);
$rsCount = $count_rs->fields["cnt"];

$param["count"] = $rsCount;
$list = makeClaimListHtml($conn, $rs, $param, $type);
