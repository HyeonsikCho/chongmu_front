...
<script type="text/javascript">
    ...
    function f_init()
    {
        ...
        frm_pay.EP_mall_id.value = "05528819";
        frm_pay.EP_mall_nm.value = "주식회사 굿프린팅";
        ...
        frm_pay.EP_user_nm.value = "김동현";
        frm_pay.EP_user_mail.value = "test@kicc.co.kr";
        frm_pay.EP_user_phone1.value = "01047433578";
        frm_pay.EP_user_phone2.value = "01047433578";
        frm_pay.EP_user_addr.value = "서울 금천구 가산동 459-9 ";
        frm_pay.EP_product_nm.value = "테스트 상품";
        frm_pay.EP_product_amt.value = "1000";
        frm_pay.EP_return_url.value = "http://<?=$_SERVER['SERVER_NAME']?>/proc/easypay80_webpay_php/web/normal/order_res.php";
    }
    ...
    function f_submit()
    {
        ...
        frm_pay.action = "http://<?=$_SERVER['SERVER_NAME']?>/proc/easypay80_webpay_php/web/easypay_request.php";
        frm_pay.submit();
    }
