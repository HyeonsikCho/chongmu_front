...
<script>
    window.onload = function()
    {
        ...
        if(window.opener != null)
        {
            ...
            window.opener.document.getElementById("EP_prepaid_cp").value     = "<?=$_POST["EP_prepaid_cp"] ?>";
            ...
            {
                window.opener.f_submit(); // order.html의 f_submit함수 실행
            }
            else
            {
        ...
        else
        {
            ...
            window.parent.document.getElementById("EP_prepaid_cp").value     = "<?=$_POST["EP_prepaid_cp"] ?>";
