...
$(document).ready(function() {
	$('.preset').find('button').attr('type', 'button');
...
var tempPop;
var info_agree = function() {
	if(!is_agreed){
		tempPop = layerPopup('l_agree', '/design_template/mypage/popup/l_agree.html', '1');
	}
}
