...
include_once($_SERVER["DOCUMENT_ROOT"] . '/com/nexmotion/common/db/adodb.inc.php');
...
class ConnectionPool {
    ...
    function ConnectionPool(
    	...
    	$databaseName = "dprinting"
    ) {
    	
        $this->dbType = $dbType; //oracle -> oci8        
        $this->connectIdentifier = ADONewConnection($dbType);
