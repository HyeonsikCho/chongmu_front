...
$param["start_range"]  = date("Y-m-d",strtotime("-5 day"));
$param["end_range"]  = date("Y-m-d");
$param["type"] = "SEQ";

$rs = $claimDAO->selectOrderList($conn, $param);

$param["type"] = "COUNT";
$count_rs = $claimDAO->selectOrderList($conn, $param);
