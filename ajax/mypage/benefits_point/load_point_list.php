...
include_once($_SERVER["DOCUMENT_ROOT"] . "/com/nexmotion/job/mypage/BenefitsPointDAO.php");
...
$fb = new FormBean();
$benefitsDAO = new BenefitsPointDAO();
...
$rs = $benefitsDAO->selectPointList($conn, $param);

$param["type"] = "COUNT";
$count_rs = $benefitsDAO->selectPointList($conn, $param);
