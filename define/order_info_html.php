...
<br />
<label class=\"control-label cp\">옵션 : %s</label>
<br />
...
<br />
<label class=\"control-label cp\">기본가격 %s + 추가후공정 %s + 추가옵션 %s + 부가세 %s = 상품가격 %s원</label>
<br />
<label class=\"control-label cp\">- 상품할인가격 %s = 정상판매가 %s원</label>
<br />
<label class=\"control-label cp\">- 회원등급할인 %s = 기본혜택가 %s원</label>
<br />
<label class=\"control-label cp\">- 사용마일리지 %s - 적용쿠폰 %s - 이벤트할인 %s = 실결제 %s 원</label>
<br />
<label class=\"control-label cp\">- 사용가능마일리지 %s - 적용가능쿠폰 %s = 최대혜택가 %s원</label>
<br /><br />";
...
<br />
<label class=\"control-label cp\">선입금 %s원, 쿠폰 %s, 마일리지 %s, 할인 %s</label>
<br />";
}
?>
